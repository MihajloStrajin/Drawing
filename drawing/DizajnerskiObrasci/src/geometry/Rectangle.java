...
public class Rectangle extends SurfaceShape {
	...
	public boolean equals(Object obj) {
		if (obj instanceof Rectangle) {
			Rectangle pros = (Rectangle) obj;
			if (this.upperLeftPoint.equals(pros.getUpperLeftPoint()) && 
					this.width == pros.getWidth() && this.height == pros.getHeight()) {
				return true;
			} else {
				return false;
			}
	...
	public String toString() {
		return "Rectangle " + "Upper left point=(" + upperLeftPoint.getX() + "," + upperLeftPoint.getY() + ")" + ", height=" + height + ", width=" + width + " Outer color " + getColor().getRGB() + " Inner color " + getInnerColor().getRGB();
	}
	
	public Rectangle clone() {
		Rectangle rect = new Rectangle();
		
		rect.getUpperLeftPoint().setX(this.getUpperLeftPoint().getX());
		rect.getUpperLeftPoint().setY(this.getUpperLeftPoint().getY());
