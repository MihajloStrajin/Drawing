...
public class DlgLine extends JDialog {
	...
	public DlgLine() {
		...
		}
		{
			...
			gbc_txtEndPointX.anchor = GridBagConstraints.NORTH;
					...
					public void actionPerformed(ActionEvent e) {
						try{
							if(txtStartPointX.getText().trim().isEmpty() || txtStartPointY.getText().trim().isEmpty() ||
								...
								isOk=true;
								line=new Line(new Point(Integer.parseInt(txtStartPointX.getText().toString()),Integer.parseInt(txtStartPointY.getText().toString())),
										new Point(Integer.parseInt(txtEndPointX.getText().toString()),Integer.parseInt(txtEndPointY.getText().toString())),
